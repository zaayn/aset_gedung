    ...
    <div class="peers ai-s fxw-nw h-100vh">
        ...
        <div class="col-12 col-md-4 peer pX-80 pY-80 h-100 bgc-white scrollable pos-r" style="min-width:320px">
            ...
            <form method="POST" action="{{ route('register') }}">
                ...
                <div class="form-group">
                    <label for="password" class="text-normal text-dark">{{ __('Confirm Password') }}</label>
                    <input id="password" type="password" name="password_confirmation" class="form-control" placeholder="Password" required>
                </div>
                <div class="form-group">
